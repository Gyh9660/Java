...
public class Ex08_NonRectangleArray {
	...
	public static void main(String[] args) {
		...
		int[][] array1 = new int[2][]; // 행의 갯수만 생성해서 밥의 크기를 만든다.
		...
		int [][] array4;
		array4 = new int[][] {{1,2,}, {3,4,5}}; // 비정방형으로 값을 바로 대입 /선언하고 나중에 값대입
		...
		// 비정방형 (NonRectangle) 선언과 값 대입 방법3
		
		int [][] array5 = {{1,2,}, {3,4,5}}; // 비정방형으로 값을 바로 대입 /선언하고 나중에 값대입
