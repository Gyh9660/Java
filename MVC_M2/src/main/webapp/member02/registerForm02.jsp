...
<script src="register02.js"></script>

	<div id = "regForm" class="box">
		<ul>
			<li><label for ="u_id">아이디</label>
				<input id = "u_id" name = "u_id" type ="email" size ="20" 
				maxlength="50" placeholder="example@kosmo.com" autofocus>
