...
<!-- 
	...
	PreparedStatement :
		...
		- 처음 컴파일 된 이후에는 컴파일을 수행하지 않는다. (cache 를사용한다)
		- 여러번 수행할때 빠른 속도를 가진다.
...
<table width = "500" border= "1">
	...
	<%
		ResultSet rs = null;		//ResultSet 객체는 DB의 테이블을 select에서 나온 결과 레코드셋을 담는 객체
		...
		try{
			...
			rs = pstmt.executeQuery();
				//pstmt.executeQuery() :select한 결과를 ResultSet객체에 저장해야함
